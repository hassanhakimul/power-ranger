...
const Footer = () => {
    return (
        <footer class="footer p-10 text-neutral-content " style={{ backgroundImage: `url(${bg})`,height:'300px'}}>
  <div>
    ...
    <p className='text-white text-2xl'>PowerRanger Ltd.<br/>Providing reliable tech since 1992</p>
  </div> 
  <div>
  <div>
    ...
    <div class="form-control w-80">
      ...
      <div class="relative">
        <input type="text" placeholder="username@site.com" class="input text-black input-bordered w-full pr-16" /> 
        <button class="btn btn-primary absolute top-0 right-0 rounded-l-none">Subscribe</button>
      </div>
    </div>
  </div>
    <span class="footer-title text-white mt-5">Social</span> 
